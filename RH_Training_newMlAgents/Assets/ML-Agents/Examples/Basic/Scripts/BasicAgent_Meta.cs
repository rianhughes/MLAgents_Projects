...
//        if(BoolWriteOutput()){Debug.Log("saving demonstration");TestStoreInitalize_2();}
    }
    ...
    public void TestStoreInitalize_2()
    {
      ...
      string k_DemoName = "TestStill" + Time.fixedTime;
        var demoStore = new DemonstrationStore_old(null);
        ...
        demoStore.Record(agentInfo, brainParameters );//new mlagents release records the agentInfo and brainParams seperately..
        //demoStore.WriteBrainParameters( brainName, brainParameters); // I overwrote the permissions...
        demoStore.Close();
    }
