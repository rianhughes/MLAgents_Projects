...
namespace MLAgents
{
    ...
    public class DemonstrationRecorderOverRide : MonoBehaviour
    {
        public int Dummy = 99;
        public bool record;
        ...
        public void InitializeDemoStore(IFileSystem fileSystem = null)
        {
            ...
            demonstrationName = SanitizeName(demonstrationName+"OVERRIDE_WORKIN", MaxNameLength);
            m_DemoStore.Initialize(
                demonstrationName,
                behaviorParams.brainParameters,
                behaviorParams.behaviorName);
            Monitor.Log("Recording Demonstration OVERRIDE of Agent: ", m_RecordingAgent.name);
        }
