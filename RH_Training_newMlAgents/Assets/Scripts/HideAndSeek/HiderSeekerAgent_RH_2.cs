...
public class HiderSeekerAgent_RH_2 : Agent{
    Rigidbody rb; 
    ...
    public HiderSeekerAgent_RH_2 Enemy; // Refernce to your enemy 
    float seekerFloat;
    bool sawEnemy = false;
    float waitPeriod = 1;
    string behaviorName;
...
//	floor_length = Floor.transform.localScale.X;
//	floor_width  = Floor.transform.localScale.Z;
        //Debug.Log(" Hello :  " + Floor.transform.localScale.X);
