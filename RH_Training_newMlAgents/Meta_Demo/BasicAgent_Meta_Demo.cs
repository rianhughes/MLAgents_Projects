...
public class BasicAgent : Agent
{
    ...
    {
        WaitTimeInference();
        if(Time.fixedTime%5==0){Debug.Log("saving demonstration");TestStoreInitalize_2();}
    }
    ...
    public void TestStoreInitalize_2()
    {
      ...
      string k_DemoName = "TestStill" + Time.fixedTime;
        ...
        demoStore.Record(agentInfo, new System.Collections.Generic.List<MLAgents.Sensor.ISensor>());
        demoStore.Close();
    }
